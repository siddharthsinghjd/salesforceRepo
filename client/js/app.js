...
function getSessionDetails(sessionId, success, error) {
  ...
  "sid16__Session__r.sid16__Description__c " +
    ...
    getSessionList(
        function (data) {
            ...
            for (var i=0; i<sessions.length; i++) {
                html += '<li class="table-view-cell"><a href="#sessions/'+ sessions[i].sid16__Session__r.Id +'">' + sessions[i].sid16__Session__r.Name + '</a></li>';
            }
            html =
                '<div class="page">' +
